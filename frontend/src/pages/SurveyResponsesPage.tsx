...
export default function SurveyResponsesPage() {
  ...
  if (error || !survey) {
    return <div className="max-w-4xl mx-auto px-4 py-10 text-red-500">{error || 'Survey not found.'}</div>;
  }
  ...
  if (!canViewResponses) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-10 text-center">
        <p className="text-gray-600 dark:text-gray-300">You can only view responses for surveys you created.</p>
        <Link
          to="/dashboard"
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Response overview</p>
      </div>
